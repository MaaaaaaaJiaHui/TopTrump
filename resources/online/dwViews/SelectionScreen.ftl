    ...
    <div class="navs">
      ...
      <div class="row">
        <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
	                <div class="col-sm-8">
		                <select class="form-control" id="aiplayer">
		                <option value="" selected>Select AI player's number.</option>
	                ...
	                <div class="col-sm-4"><!-- href="/toptrumps/game"-->
	                	<a href="#" class="btn btn-primary" onclick="newgame()">Go</a>
	                </div>
	            </div>
              </div>
            </div>
		...
		function newgame(){
			num = $('#aiplayer').val();
			if(num){
				window.location.href="/toptrumps/game?ainum="+num;
			}else{
